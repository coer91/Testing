...
GO
/*
The type for column Name in table [dbo].[TblLanguages] is currently  NVARCHAR (50) NOT NULL but is being changed to  NVARCHAR (10) NOT NULL. Data loss could occur and deployment may fail if the column contains data that is incompatible with type  NVARCHAR (10) NOT NULL.
*/
...
GO
PRINT N'Dropping Unique Constraint [dbo].[UN_TblLanguages_Name]...';


GO
ALTER TABLE [dbo].[TblLanguages] DROP CONSTRAINT [UN_TblLanguages_Name];
...
GO
PRINT N'Altering Table [dbo].[TblLanguages]...';


GO
ALTER TABLE [dbo].[TblLanguages] ALTER COLUMN [Name] NVARCHAR (10) NOT NULL;


GO
PRINT N'Creating Unique Constraint [dbo].[UN_TblLanguages_Name]...';


GO
ALTER TABLE [dbo].[TblLanguages]
    ADD CONSTRAINT [UN_TblLanguages_Name] UNIQUE NONCLUSTERED ([Name] ASC);
