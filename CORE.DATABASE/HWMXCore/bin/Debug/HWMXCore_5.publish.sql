...
IF NOT EXISTS(SELECT 1 FROM TblProjectsModules WHERE ProjectId = @HWMXPDAId AND [Name] = @Module)
	INSERT INTO TblProjectsModules ([Name], Icon, ProjectId, MenuTypeId, [Sequence])
	VALUES (@Module, @Icon, @HWMXPDAId, @GRID, 1);
...
IF NOT EXISTS(SELECT 1 FROM TblProjectsModules WHERE ProjectId = @HWMXPDAId AND [Name] = @Module)
	INSERT INTO TblProjectsModules ([Name], Icon, ProjectId, MenuTypeId, [Sequence])
	VALUES (@Module, @Icon, @HWMXPDAId, @GRID, 2);
...
IF NOT EXISTS(SELECT 1 FROM TblProjectsModules WHERE ProjectId = @HWMXPDAId AND [Name] = @Module)
	INSERT INTO TblProjectsModules ([Name], Icon, ProjectId, MenuTypeId, [Sequence])
	VALUES (@Module, @Icon, @HWMXPDAId, @GRID, 3); 
...
IF NOT EXISTS(SELECT 1 FROM TblProjectsModules WHERE ProjectId = @HWMXPDAId AND [Name] = @Module)
	INSERT INTO TblProjectsModules ([Name], Icon, ProjectId, MenuTypeId, [Sequence])
	VALUES (@Module, @Icon, @HWMXPDAId, @GRID, 4);
...
IF NOT EXISTS(SELECT 1 FROM TblProjectsModules WHERE ProjectId = @HWMXPDAId AND [Name] = @Module)
	INSERT INTO TblProjectsModules ([Name], Icon, ProjectId, MenuTypeId, [Sequence])
	VALUES (@Module, @Icon, @HWMXPDAId, @GRID, 5);
...
IF NOT EXISTS(SELECT 1 FROM TblProjectsModules WHERE ProjectId = @HWMXPDAId AND [Name] = @Module)
	INSERT INTO TblProjectsModules ([Name], Icon, ProjectId, MenuTypeId, [Sequence])
	VALUES (@Module, @Icon, @HWMXPDAId, @GRID, 6);
...
IF NOT EXISTS(SELECT 1 FROM TblProjectsModules WHERE ProjectId = @HWMXPDAId AND [Name] = @Module)
	INSERT INTO TblProjectsModules ([Name], Icon, ProjectId, MenuTypeId, [Sequence])
	VALUES (@Module, @Icon, @HWMXPDAId, @GRID, 7);
...
IF NOT EXISTS(SELECT 1 FROM TblProjectsModules WHERE ProjectId = @HWMXPDAId AND [Name] = @Module)
	INSERT INTO TblProjectsModules ([Name], Icon, ProjectId, MenuTypeId, [Sequence])
	VALUES (@Module, @Icon, @HWMXPDAId, @GRID, 8);
...
IF NOT EXISTS(SELECT 1 FROM TblProjectsModules WHERE ProjectId = @HWMXPDAId AND [Name] = @Module)
	INSERT INTO TblProjectsModules ([Name], Icon, ProjectId, MenuTypeId, [Sequence])
	VALUES (@Module, @Icon, @HWMXPDAId, @GRID, 9);
