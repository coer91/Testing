...
GO
ALTER TABLE [dbo].[TblProjectsModules] DROP CONSTRAINT [DF__TblProjec__MenuT__6E01572D];
...
GO
ALTER TABLE [dbo].[TblProjectsModules] DROP CONSTRAINT [DF__TblProjec__Seque__6EF57B66];
...
GO
ALTER TABLE [dbo].[TblProjectsSubmodules] DROP CONSTRAINT [DF__TblProjec__MenuT__70DDC3D8];
...
GO
ALTER TABLE [dbo].[TblProjectsSubmodules] DROP CONSTRAINT [DF__TblProjec__Seque__71D1E811];
...
GO
PRINT N'Dropping Foreign Key [dbo].[FK_TblUsers_PartnerId]...';


GO
ALTER TABLE [dbo].[TblUsers] DROP CONSTRAINT [FK_TblUsers_PartnerId];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_TblProjectsModules] ([Id], [Name], [Icon], [ProjectId], [MenuTypeId], [Sequence])
        SELECT   [Id],
                 [Name],
                 [Icon],
                 [ProjectId],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_TblProjectsSubmodules] ([Id], [Name], [Icon], [ModuleId], [MenuTypeId], [Sequence])
        SELECT   [Id],
                 [Name],
                 [Icon],
                 [ModuleId],
...
GO
ALTER TABLE [dbo].[TblUsers] ALTER COLUMN [PartnerId] INT NULL;
