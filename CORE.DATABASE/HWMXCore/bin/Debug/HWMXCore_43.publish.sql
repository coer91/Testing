...
CREATE TABLE [dbo].[TblProjectsModules] (
    ...
    CONSTRAINT [UN_TblProjectsModules_TranslatoryId] UNIQUE NONCLUSTERED ([TranslatoryId] ASC)
);
...
CREATE TABLE [dbo].[TblProjectsPages] (
    ...
    CONSTRAINT [UN_TblProjectsPages_ActiveKey] UNIQUE NONCLUSTERED ([ActiveKey] ASC),
    ...
    CONSTRAINT [UN_TblProjectsPages_TranslatoryId] UNIQUE NONCLUSTERED ([TranslatoryId] ASC)
);
...
CREATE TABLE [dbo].[TblProjectsSubmodules] (
    ...
    CONSTRAINT [UN_TblProjectsSubmodules_TranslatoryId] UNIQUE NONCLUSTERED ([TranslatoryId] ASC)
);
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[TblUsers]...';


GO
ALTER TABLE [dbo].[TblUsers]
    ADD DEFAULT ('en_US') FOR [LanguageId];
