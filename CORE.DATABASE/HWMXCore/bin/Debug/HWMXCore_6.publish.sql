...
GO
ALTER TABLE [dbo].[TblProjectsModules] DROP CONSTRAINT [DF__TblProjec__MenuT__02084FDA];
...
GO
ALTER TABLE [dbo].[TblProjectsModules] DROP CONSTRAINT [DF__TblProjec__Seque__02FC7413];
...
GO
ALTER TABLE [dbo].[TblProjectsSubmodules] DROP CONSTRAINT [DF__TblProjec__MenuT__07C12930];
...
GO
ALTER TABLE [dbo].[TblProjectsSubmodules] DROP CONSTRAINT [DF__TblProjec__Seque__08B54D69];
