...
BEGIN	  
	IF NOT EXISTS(SELECT 1 FROM dbo.TblLanguages WHERE Id = 1)
		INSERT INTO dbo.TblLanguages (Id, [Name])
		VALUES (1, 'English'); 

	IF NOT EXISTS(SELECT 1 FROM dbo.TblLanguages WHERE Id = 2)
		INSERT INTO dbo.TblLanguages (Id, [Name])
		VALUES (2, 'Español');
		
	IF NOT EXISTS(SELECT 1 FROM dbo.TblLanguages WHERE Id = 3)
		INSERT INTO dbo.TblLanguages (Id, [Name])
		VALUES (3, '한국어');
END
GO
