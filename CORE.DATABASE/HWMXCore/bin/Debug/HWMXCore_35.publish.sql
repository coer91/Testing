...
IF NOT EXISTS (SELECT 1 FROM dbo.TblTranslatory WHERE English = @Page)
	INSERT INTO dbo.TblTranslatory (English, Spanish, Korean)
	VALUES (@Page, N'Entrada LP', N'LP 항목');
SET @TranslatoryId = (SELECT Id FROM dbo.TblTranslatory WHERE English = @Page);
...
IF NOT EXISTS (SELECT 1 FROM dbo.TblTranslatory WHERE English = @Page)
	INSERT INTO dbo.TblTranslatory (English, Spanish, Korean)
	VALUES (@Page, N'Entrada GKD', N'GKD 항목');
SET @TranslatoryId = (SELECT Id FROM dbo.TblTranslatory WHERE English = @Page);
...
IF NOT EXISTS (SELECT 1 FROM dbo.TblTranslatory WHERE English = @Page)
	INSERT INTO dbo.TblTranslatory (English, Spanish, Korean)
	VALUES (@Page, N'Entrada CC', N'CC 항목');
SET @TranslatoryId = (SELECT Id FROM dbo.TblTranslatory WHERE English = @Page);
...
IF NOT EXISTS (SELECT 1 FROM dbo.TblTranslatory WHERE English = @Page)
	INSERT INTO dbo.TblTranslatory (English, Spanish, Korean)
	VALUES (@Page, N'Devolución del proveedor', N'공급업체 반품');
SET @TranslatoryId = (SELECT Id FROM dbo.TblTranslatory WHERE English = @Page);
...
IF NOT EXISTS (SELECT 1 FROM dbo.TblTranslatory WHERE English = @Page)
	INSERT INTO dbo.TblTranslatory (English, Spanish, Korean)
	VALUES (@Page, N'Devolución de la inspección', N'검사 반환');
SET @TranslatoryId = (SELECT Id FROM dbo.TblTranslatory WHERE English = @Page);
...
IF NOT EXISTS (SELECT 1 FROM dbo.TblTranslatory WHERE English = @Module)
	INSERT INTO dbo.TblTranslatory (English, Spanish, Korean)
	VALUES (@Module, N'Reciclar', N'재활용');
