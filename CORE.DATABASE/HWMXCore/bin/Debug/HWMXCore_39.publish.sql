...
GO
PRINT N'Dropping Unique Constraint [dbo].[UN_TblProjectsModules_TranslatoryId_ProjectId]...';


GO
ALTER TABLE [dbo].[TblProjectsModules] DROP CONSTRAINT [UN_TblProjectsModules_TranslatoryId_ProjectId];
...
GO
PRINT N'Dropping Unique Constraint [dbo].[UN_TblProjectsSubmodules_ModuleId_TranslatoryId]...';


GO
ALTER TABLE [dbo].[TblProjectsSubmodules] DROP CONSTRAINT [UN_TblProjectsSubmodules_ModuleId_TranslatoryId];
...
GO
PRINT N'Creating Unique Constraint [dbo].[UN_TblProjectsModules_TranslatoryId]...';


GO
ALTER TABLE [dbo].[TblProjectsModules]
    ADD CONSTRAINT [UN_TblProjectsModules_TranslatoryId] UNIQUE NONCLUSTERED ([TranslatoryId] ASC);


GO
PRINT N'Creating Unique Constraint [dbo].[UN_TblProjectsPages_ActiveKey]...';


GO
ALTER TABLE [dbo].[TblProjectsPages]
    ADD CONSTRAINT [UN_TblProjectsPages_ActiveKey] UNIQUE NONCLUSTERED ([ActiveKey] ASC);


GO
PRINT N'Creating Unique Constraint [dbo].[UN_TblProjectsPages_TranslatoryId]...';


GO
ALTER TABLE [dbo].[TblProjectsPages]
    ADD CONSTRAINT [UN_TblProjectsPages_TranslatoryId] UNIQUE NONCLUSTERED ([TranslatoryId] ASC);


GO
PRINT N'Creating Unique Constraint [dbo].[UN_TblProjectsSubmodules_TranslatoryId]...';


GO
ALTER TABLE [dbo].[TblProjectsSubmodules]
    ADD CONSTRAINT [UN_TblProjectsSubmodules_TranslatoryId] UNIQUE NONCLUSTERED ([TranslatoryId] ASC);
