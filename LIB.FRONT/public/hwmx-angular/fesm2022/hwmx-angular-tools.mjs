        ...
        if (this.useJWT) {
            ...
            if (JWT.claims?.hasOwnProperty('User')) {
                return {
                    ...
                    RoleId: Number(JWT.claims?.roleId || 0),
...
class HTTP {
    ...
    static _BuildHeaders(method) {
        ...
        if (Tools.IsNotOnlyWhiteSpace(USER?.Role))
            headers.append('User-Role', USER.Role);
...
class Page {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: Page, deps: [{ token: String }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.6", type: Page, isStandalone: true, selector: "ng-component", ngImport: i0, template: '', isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: Page, decorators: [{
            type: Component,
            args: [{ template: '' }]
...
class Section {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: Section, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.2.6", type: Section, isStandalone: true, selector: "ng-component", inputs: { isLoadingExternal: { classPropertyName: "isLoadingExternal", publicName: "isLoadingExternal", isSignal: true, isRequired: false, transformFunction: null }, isUpdating: { classPropertyName: "isUpdating", publicName: "isUpdating", isSignal: true, isRequired: false, transformFunction: null }, canCreate: { classPropertyName: "canCreate", publicName: "canCreate", isSignal: true, isRequired: false, transformFunction: null }, canUpdate: { classPropertyName: "canUpdate", publicName: "canUpdate", isSignal: true, isRequired: false, transformFunction: null }, canDelete: { classPropertyName: "canDelete", publicName: "canDelete", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: '', isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: Section, decorators: [{
            type: Component,
            args: [{ template: '' }]
        }], propDecorators: { isLoadingExternal: [{ type: i0.Input, args: [{ isSignal: true, alias: "isLoadingExternal", required: false }] }], isUpdating: [{ type: i0.Input, args: [{ isSignal: true, alias: "isUpdating", required: false }] }], canCreate: [{ type: i0.Input, args: [{ isSignal: true, alias: "canCreate", required: false }] }], canUpdate: [{ type: i0.Input, args: [{ isSignal: true, alias: "canUpdate", required: false }] }], canDelete: [{ type: i0.Input, args: [{ isSignal: true, alias: "canDelete", required: false }] }] } });
