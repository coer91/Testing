...
import { Page, Tools, Collections, Strings, HTMLElements, Screen, Navigation, Access, CoerAlert, Dates } from 'hwmx-angular/tools';
import { selectedMenuSIGNAL, navigationSIGNAL, isLoadingSIGNAL, screenSizeSIGNAL, userSIGNAL, userImageSIGNAL, environmentSIGNAL, navigationKeysSIGNAL } from 'hwmx-angular/signals';
...
class MenuPage extends Page {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: MenuPage, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.6", type: MenuPage, isStandalone: false, selector: "menu-page", usesInheritance: true, ngImport: i0, template: "<!-- Title -->\r\n<wia-page-title\r\n    [title]=\"title()\"\r\n    [breadcrumbs]=\"breadcrumbs()\"\r\n></wia-page-title> \r\n\r\n<nav>\r\n    @for(item of _pages(); track item.Id) {           \r\n        <a [routerLink]=\"_getPath(item)\" class=\"animation-fadeIn\">\r\n            @if((item?.Icon || '').length > 0) {\r\n                <i [class]=\"item!.Icon\"></i>\r\n            }\r\n            <span> {{ item.Label }} </span>\r\n        </a> \r\n    }\r\n</nav>", styles: ["nav{display:flex!important;flex-wrap:wrap!important;margin:30px!important;gap:30px!important}nav a{display:flex!important;align-items:center!important;justify-content:center!important;flex-direction:column!important;flex-basis:150px!important;padding:10px!important;gap:10px!important;height:150px!important;max-height:150px!important;text-decoration:none!important;font-weight:700!important;border:2px ridge var(--sidenav)!important;border-radius:5px!important;color:var(--sidenav)!important;flex-grow:1!important;overflow:hidden!important}nav a i{font-size:35px!important}nav a span{text-align:center!important}nav a:not(.menu):hover{box-shadow:0 0 15px -4px var(--navigation)!important;border-color:var(--navigation)!important;color:var(--navigation)!important;background-color:var(--containers)!important}@media(min-width:0px)and (max-width:499px){nav{margin:20px!important;gap:10px!important}nav a{justify-content:flex-start!important;flex-direction:row!important;flex-basis:100%!important;flex-grow:0!important;height:26px!important;max-height:26px!important;white-space:nowrap!important}nav a i{font-size:20px!important;min-width:20px!important}nav a span{width:calc(100% - 20px);overflow:hidden!important;text-overflow:ellipsis!important;justify-content:flex-start!important;display:flex!important}}\n"], dependencies: [{ kind: "directive", type: i1.RouterLink, selector: "[routerLink]", inputs: ["target", "queryParams", "fragment", "queryParamsHandling", "state", "info", "relativeTo", "preserveFragment", "skipLocationChange", "replaceUrl", "routerLink"] }, { kind: "component", type: i3.WIAPageTitle, selector: "wia-page-title", inputs: ["title", "showBreadcrumbs", "breadcrumbs", "goBack", "information"], outputs: ["onClickInformation", "onClickGoBack"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: MenuPage, decorators: [{
            type: Component,
...
class Sidenav {
    ...
    constructor() {
        ...
        this._router.events
            ...
            // else if(Array.from(navigationKeysSIGNAL().keys()).includes(url.requested)) {
            //     console.log('')
            // }
        });
    }
...
class Toolbar {
    ...
    _role = signal(null, ...(ngDevMode ? [{ debugName: "_role" }] : /* istanbul ignore next */ []));
    IsNotOnlyWhiteSpace = Tools.IsNotOnlyWhiteSpace;
    //Inputs
    ...
    }, ...(ngDevMode ? [{ debugName: "_roleList" }] : /* istanbul ignore next */ []));
    //Computed
    _icon = computed(() => {
...
class WiaRoot {
    ...
    async UpdateRole(roleId) {
        if (Tools.IsFunction(this.authService()?.SetUserRoleMain)) {
            const FUNCTION = this.authService().SetUserRoleMain;
            isLoadingSIGNAL.set(true);
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: WiaRoot, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.2.0", version: "21.2.6", type: WiaRoot, isStandalone: false, selector: "wia-root", inputs: { authService: { classPropertyName: "authService", publicName: "authService", isSignal: true, isRequired: true, transformFunction: null }, staticNavigation: { classPropertyName: "staticNavigation", publicName: "staticNavigation", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { onLogin: "onLogin", onRecoveryPassword: "onRecoveryPassword", onUpdatePassword: "onUpdatePassword", onUpdateRole: "onUpdateRole", onUpdateJWT: "onUpdateJWT", onClickToolbarMenu: "onClickToolbarMenu" }, viewQueries: [{ propertyName: "_coer91", first: true, predicate: ["WiaComponent"], descendants: true, isSignal: true }], ngImport: i0, template: `
        <wia-component
            #WiaComponent 
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: WiaRoot, decorators: [{
    ...
    `
        ...
        }], ctorParameters: () => [], propDecorators: { _coer91: [{ type: i0.ViewChild, args: ['WiaComponent', { isSignal: true }] }], authService: [{ type: i0.Input, args: [{ isSignal: true, alias: "authService", required: true }] }], staticNavigation: [{ type: i0.Input, args: [{ isSignal: true, alias: "staticNavigation", required: false }] }], onLogin: [{ type: i0.Output, args: ["onLogin"] }], onRecoveryPassword: [{ type: i0.Output, args: ["onRecoveryPassword"] }], onUpdatePassword: [{ type: i0.Output, args: ["onUpdatePassword"] }], onUpdateRole: [{ type: i0.Output, args: ["onUpdateRole"] }], onUpdateJWT: [{ type: i0.Output, args: ["onUpdateJWT"] }], onClickToolbarMenu: [{ type: i0.Output, args: ["onClickToolbarMenu"] }] } });

//Modules
class CoreModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: CoreModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.6", ngImport: i0, type: CoreModule, declarations: [MenuPage,
            WiaComponent,
            WiaRoot,
            HomePage,
            LoginPage,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: CoreModule, imports: [CommonModule,
            RouterModule,
            FormsModule,
            ReactiveFormsModule,
            ComponentsModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.6", ngImport: i0, type: CoreModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
const ActiveKeyGuard = async ({ data }, { url }) => {
    ...
    if (Tools.IsNotOnlyWhiteSpace(ACTIVE_KEY)) {
        ...
        isLoadingSIGNAL.set(false);
        if (navigationKeys.includes(ACTIVE_KEY))
            return true;
        else {
...
/** */
const ROUTER_PAGE = (path, component, routerParams = [], activeKey = '') => {
