import { AfterViewInit, Component, computed, ElementRef, input, output, Signal, signal, viewChild, WritableSignal } from '@angular/core'; 
import { TemplateRefDirective } from 'hwmx-angular/directives';
import { IInputChange, IHeaderSettings, IImportButton } from 'hwmx-angular/interfaces';
import { CoerAlert, Files, Strings, Tools } from 'hwmx-angular/tools';

@Component({
    selector: 'wia-grid-header',
    templateUrl: './wia-grid-header.component.html',
    standalone: false
})
export class WIAGridHeader<T> implements AfterViewInit { 
