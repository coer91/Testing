...
import { Collections, CONTROL_VALUE, ControlValue, HTMLElements, Tools } from 'hwmx-angular/tools';
import { ITemplateRef, TemplateRefDirective } from 'hwmx-angular/directives';

@Component({
    selector: 'wia-tab',
    templateUrl: './wia-tab.component.html', 
    styleUrl: './wia-tab.component.scss',
    providers: [CONTROL_VALUE(WIATab)], 
    standalone: false
})
export class WIATab extends ControlValue implements AfterContentChecked { 
