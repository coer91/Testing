...
import { CONTROL_VALUE, Numbers, Tools } from 'hwmx-angular/tools';
import { WIATextBox } from '../wia-textbox/wia-textbox.component';

@Component({
    selector: 'wia-numberbox',
    templateUrl: '../wia-textbox/wia-textbox.component.html', 
    styleUrl: '../wia-textbox/wia-textbox.component.scss', 
    providers: [CONTROL_VALUE(WIANumberBox)],
    standalone: false
})
export class WIANumberBox extends WIATextBox {  
