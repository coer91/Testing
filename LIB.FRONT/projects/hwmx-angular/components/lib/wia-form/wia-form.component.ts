...
import { CoerAlert, Tools } from 'hwmx-angular/tools';
...
import { WIARadio } from '../wia-radio/wia-radio.component';

@Component({
    selector: 'wia-form',
    templateUrl: './wia-form.component.html', 
    styleUrl: './wia-form.component.scss', 
    standalone: false
})
export class WIAForm implements AfterViewInit, OnDestroy { 
    ...
    public controls   = input.required<(WIATextBox | WIANumberBox | WIASwitch | WIASelectBox<any> | WIARadio<any>)[]>();  
