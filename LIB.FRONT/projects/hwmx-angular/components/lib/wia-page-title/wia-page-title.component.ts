...
import { ITitleBreadcrumb, ITitleGoBack, ITitleInformation } from 'hwmx-angular/interfaces';
import { isLoadingSIGNAL, screenSizeSIGNAL } from 'hwmx-angular/signals'; 
import { Collections, Navigation, Tools } from 'hwmx-angular/tools';  

@Component({
    selector: 'wia-page-title',
    templateUrl: './wia-page-title.component.html',
    styleUrls: ['./wia-page-title.component.scss'],
    standalone: false
})
export class WIAPageTitle {
