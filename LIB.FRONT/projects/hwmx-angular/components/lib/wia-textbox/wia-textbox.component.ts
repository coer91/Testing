...
import { CONTROL_VALUE, ControlValue, HTMLElements, Tools, Translatory } from 'hwmx-angular/tools';
import { IExternalButton } from 'hwmx-angular/interfaces';

@Component({
    selector: 'wia-textbox',
    templateUrl: './wia-textbox.component.html', 
    styleUrl: './wia-textbox.component.scss',
    providers: [CONTROL_VALUE(WIATextBox)],
    standalone: false
})
export class WIATextBox extends ControlValue {  
