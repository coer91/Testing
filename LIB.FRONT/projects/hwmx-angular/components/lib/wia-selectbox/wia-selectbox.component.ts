...
import { Collections, CONTROL_VALUE, HTMLElements, Numbers, Tools } from 'hwmx-angular/tools';
import { WIATextBox } from '../wia-textbox/wia-textbox.component';

@Component({
    selector: 'wia-selectbox',
    templateUrl: '../wia-textbox/wia-textbox.component.html', 
    styleUrl: '../wia-textbox/wia-textbox.component.scss', 
    providers: [CONTROL_VALUE(WIASelectBox)],
    standalone: false
})
export class WIASelectBox<T> extends WIATextBox {   
