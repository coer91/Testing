import { IAuthService, IHttpResponse, ILogin, ILoginResponse, IMenu, IToolbarMenu, IUser, IUserRole } from 'hwmx-angular/interfaces'; 
import { Component, input, output, signal, viewChild } from '@angular/core'; 
import { isLoadingSIGNAL, userSIGNAL } from 'hwmx-angular/signals';  
import { Access, HTTP, Tools } from 'hwmx-angular/tools'; 
import { WiaComponent } from './wia.component';
...
export class WiaRoot { 

    //Elements
    protected readonly _coer91 = viewChild.required<WiaComponent>('WiaComponent');
