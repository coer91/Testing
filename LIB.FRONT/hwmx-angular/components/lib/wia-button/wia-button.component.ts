...
import { IBreakpointButton } from 'hwmx-angular/interfaces';
import { screenSizeSIGNAL } from 'hwmx-angular/signals';
import { HTMLElements, Tools } from 'hwmx-angular/tools'; 

@Component({
    selector: 'wia-button',
    templateUrl: './wia-button.component.html', 
    styleUrl: './wia-button.component.scss', 
    standalone: false
})
export class WIAButton implements AfterViewInit, OnDestroy {    
