...
import { HTMLElements, Strings, Tools } from 'hwmx-angular/tools';

@Component({
    selector: 'wia-modal',
    templateUrl: './wia-modal.component.html', 
    styleUrl: './wia-modal.component.scss', 
    standalone: false
})
export class WIAModal implements AfterViewInit, OnDestroy {     
