import { AfterViewInit, Component, inject, input, OnDestroy, signal, WritableSignal } from "@angular/core"; 
import { CoerAlert } from "./coer-alert/coer-alert.component";
import { ICallbackItem, ICellSwitch } from "hwmx-angular/interfaces"; 
