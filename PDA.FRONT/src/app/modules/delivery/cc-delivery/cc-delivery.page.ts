...
export class CCDeliveryPage extends PagePDA {  
    ...
    /** */
    protected async GetLot(scanner: string): Promise<LOT_INFORMATION_DTO | null> {     
    ...
    /** */
    protected template = (item: ICallbackItem<LOT_INFORMATION_DTO>) => '';//`${item.row.Detail.length}`;
}