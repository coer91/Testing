namespace HWMX.DotNet.ORM
{
    ...
    {         
        ...
        protected async Task CreateRepository()
        {
            ...
            string directoryPath = Files.CreateDirectory($"{_rootPath}/{_profile.OutputFiles.IRepositoryOutput}");
            ...
            directoryPath = Files.CreateDirectory($"{_rootPath}/{_profile.OutputFiles.RepositoryOutput}");
        ...
        protected async Task CreateDto()
        {
            ...
            string directoryPath = Files.CreateDirectory($"{_rootPath}/{_profile.OutputFiles.DtoOutput}");
        ...
        protected async Task CreateMapper()
        {
            ...
            string directoryPath = Files.CreateDirectory($"{_rootPath}/{_profile.OutputFiles.AutoMapperOutput}");
        ...
        protected async Task CreateService()
        {
            ...
            string directoryPath = Files.CreateDirectory($"{_rootPath}/{_profile.OutputFiles.IServiceOutput}");
            ...
            directoryPath = Files.CreateDirectory($"{_rootPath}/{_profile.OutputFiles.ServiceOutput}");
        ...
        protected async Task CreateController()
        {
            ...
            string directoryPath = Files.CreateDirectory($"{_rootPath}/{_profile.OutputFiles.ControllerOutput}");
        ...
        protected async Task CreateTests()
        {
            ...
            string directoryPath = Files.CreateDirectory($"{_rootPath}/{_profile.OutputFiles.TestOutput}");
