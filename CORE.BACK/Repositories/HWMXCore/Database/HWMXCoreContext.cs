...
public partial class HWMXCoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblProjectsModule>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Name, e.ProjectId }, "UN_TblProjectsModules_Name_ProjectId").IsUnique();
        ...
        modelBuilder.Entity<TblProjectsPage>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ProjectId, e.ModuleId, e.SubmoduleId, e.Name }, "UN_TblProjectsPages_ProjectId_ModuleId_SubmoduleId_Name").IsUnique();

            entity.HasIndex(e => new { e.ProjectId, e.Path }, "UN_TblProjectsPages_ProjectId_Path").IsUnique();
        ...
        modelBuilder.Entity<TblProjectsSubmodule>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ModuleId, e.Name }, "UN_TblProjectsSubmodules_ModuleId_Name").IsUnique();
