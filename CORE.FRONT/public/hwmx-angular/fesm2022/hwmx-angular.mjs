...
class HWMXModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: HWMXModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.17", ngImport: i0, type: HWMXModule, imports: [CommonModule,
            RouterModule,
            RouterOutlet,
            FormsModule,
            ...
            RouterOutlet,
            FormsModule,
            ReactiveFormsModule, components.WIAButton, components.WIADateBox, components.WIAForm, components.WIAGrid, components.WIALoading, components.WIAModal, components.WIANumberBox, components.WIAPageTitle, components.WIARadio, components.WIASecretBox, components.WIASelectBox, components.WIASwitch, components.WIATab, components.WIATextBox, core.WiaRoot, directives.TemplateRefDirective, pipes.DatePipe, pipes.DateTimePipe, pipes.CurrencyPipe, pipes.HtmlPipe, pipes.IndexCollectionPipe, pipes.NoImagePipe, pipes.NumericFormatPipe, pipes.TimePipe, pipes.TranslatoryPipe, tools.CoerAlert] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: HWMXModule, providers: [
            tools.CoerAlert
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: HWMXModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
