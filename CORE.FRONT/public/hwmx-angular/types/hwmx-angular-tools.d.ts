...
declare abstract class ControlValue implements AfterViewInit, OnDestroy {
    ...
    readonly translatory: _angular_core.InputSignal<"en_US" | "es_MX" | "ko-KR" | null>;
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<ControlValue, "ng-component", never, { "value": { "alias": "value"; "required": false; "isSignal": true; }; "formControlName": { "alias": "formControlName"; "required": false; "isSignal": true; }; "label": { "alias": "label"; "required": false; "isSignal": true; }; "translatory": { "alias": "translatory"; "required": false; "isSignal": true; }; "isLoading": { "alias": "isLoading"; "required": false; "isSignal": true; }; "isReadonly": { "alias": "isReadonly"; "required": false; "isSignal": true; }; "isInvisible": { "alias": "isInvisible"; "required": false; "isSignal": true; }; "isHidden": { "alias": "isHidden"; "required": false; "isSignal": true; }; "isValid": { "alias": "isValid"; "required": false; "isSignal": true; }; "isInvalid": { "alias": "isInvalid"; "required": false; "isSignal": true; }; "marginTop": { "alias": "marginTop"; "required": false; "isSignal": true; }; "marginRight": { "alias": "marginRight"; "required": false; "isSignal": true; }; "marginBottom": { "alias": "marginBottom"; "required": false; "isSignal": true; }; "marginLeft": { "alias": "marginLeft"; "required": false; "isSignal": true; }; }, { "onValueChange": "onValueChange"; "onDestroy": "onDestroy"; "onReady": "onReady"; }, never, never, true, never>;
}
...
declare abstract class Page implements AfterViewInit, OnDestroy {
    ...
    /** */
    protected readonly language: _angular_core.WritableSignal<"en_US" | "es_MX" | "ko-KR" | null>;
    /** */
...
declare class Translatory {
    static Label: (label: string, language?: "en_US" | "es_MX" | "ko-KR" | null) => string;
}
