...
import { IMenu, IMenuSelected, IToolbarMenu, ILogin, ILoginResponse, IUser, IAuthService, IActiveKey } from 'hwmx-angular/interfaces';
...
declare class Toolbar implements AfterViewInit {
    ...
    protected readonly _language: _angular_core.WritableSignal<{
        Id: string;
        Name: string;
    } | null>;
    ...
    protected readonly onUpdateLanguage: _angular_core.OutputEmitterRef<{
        Id: string;
        Name: string;
    }>;
    protected _languageList: _angular_core.Signal<{
        Id: string;
        Name: string;
    }[]>;
    constructor();
    ...
    protected _UpdateLanguage(language: {
        Id: string;
        Name: string;
    }): void;
...
declare class SidenavAccordion implements AfterViewInit, OnDestroy {
    ...
    showIndex: _angular_core.InputSignal<number>;
...
declare class Sidenav {
    ...
    protected _SetSelectedMenu(path?: string | null): Promise<void>;
...
declare class WiaRoot {
    ...
    /** */
    protected UpdateLanguage(language: {
        Id: string;
        Name: string;
    }): Promise<void>;
    /** */
...
/** */
declare const ROUTER_PAGE: (path: string, component: Type<any>, activeKey?: string) => Route;
/** */
declare const ROUTES_WIA: Route[];
/** */
declare const GetNavigationKeys: () => Map<string, IActiveKey>;
