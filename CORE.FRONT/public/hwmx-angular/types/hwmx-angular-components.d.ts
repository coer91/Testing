...
import { IBreakpointButton, IExternalButton, IRadio, IHeaderSettings, IImportButton, IInputChange, IColumnConfig, IBodySettings, IInputEnter, ISort, IDataSourceGroup, ISelectedRow, IColumn, IFooterSettings, ITitleBreadcrumb, ITitleGoBack, ITitleInformation } from 'hwmx-angular/interfaces';
import { ControlValue, CoerAlert } from 'hwmx-angular/tools';
import * as i21 from '@angular/forms';
import { FormGroup } from '@angular/forms';
import * as i22 from 'hwmx-angular/directives';
import { TemplateRefDirective, ITemplateRef } from 'hwmx-angular/directives';
import * as i20 from '@angular/router';
import { Router } from '@angular/router';
import { Subscription } from 'rxjs';
import * as i19 from '@angular/common';
import * as i23 from 'hwmx-angular/pipes';
...
declare class WIARadio<T> extends ControlValue {
    protected readonly _value: _angular_core.WritableSignal<IRadio<T> | null>;
    readonly value: _angular_core.InputSignal<IRadio<T> | null>;
    readonly dataSource: _angular_core.InputSignal<IRadio<T>[]>;
    readonly position: _angular_core.InputSignal<"vertical" | "horizontal">;
    readonly labelPosition: _angular_core.InputSignal<"left" | "right">;
    readonly breakLabel: _angular_core.InputSignal<boolean>;
    readonly showBackround: _angular_core.InputSignal<boolean>;
    readonly width: _angular_core.InputSignal<string>;
    readonly maxWidth: _angular_core.InputSignal<string>;
    protected _dataSource: _angular_core.Signal<any[]>;
    /** Sets the value of the component */
    protected _SetValue(option: IRadio<T> | null): void;
    protected _ClickOption(index: number): void;
    /** */
    Select(callback: (option: T) => boolean): void;
    /** */
    Unselect(): void;
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<WIARadio<any>, never>;
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<WIARadio<any>, "wia-radio", never, { "value": { "alias": "value"; "required": false; "isSignal": true; }; "dataSource": { "alias": "dataSource"; "required": false; "isSignal": true; }; "position": { "alias": "position"; "required": false; "isSignal": true; }; "labelPosition": { "alias": "labelPosition"; "required": false; "isSignal": true; }; "breakLabel": { "alias": "breakLabel"; "required": false; "isSignal": true; }; "showBackround": { "alias": "showBackround"; "required": false; "isSignal": true; }; "width": { "alias": "width"; "required": false; "isSignal": true; }; "maxWidth": { "alias": "maxWidth"; "required": false; "isSignal": true; }; }, {}, never, never, false, never>;
}
...
declare class WIAForm implements AfterViewInit, OnDestroy {
    ...
    controls: _angular_core.InputSignal<(WIATextBox | WIASwitch | WIANumberBox | WIASelectBox<any> | WIARadio<any>)[]>;
...
declare class WIAGridHeader<T> implements AfterViewInit {
    ...
    protected readonly onSearchChange: _angular_core.OutputEmitterRef<string>;
...
declare class WIAGridCell<T> implements AfterViewInit {
    ...
    protected _GetBackground: _angular_core.Signal<string>;
    /** */
...
declare class WIAGridBody<T> implements OnDestroy {
    ...
    protected readonly elementsByPages: Set<string>;
    protected _isLoadingPaginator: boolean;
    ...
    readonly minHeight: _angular_core.InputSignal<string>;
    readonly maxHeight: _angular_core.InputSignal<string>;
    readonly pagesLoaded: _angular_core.InputSignal<number>;
    protected readonly onClickRow: _angular_core.OutputEmitterRef<T>;
    protected readonly onDoubleClickRow: _angular_core.OutputEmitterRef<T>;
    ...
    protected readonly onLoadPages: _angular_core.OutputEmitterRef<number>;
    constructor();
    ngOnDestroy(): void;
...
declare class WIAGrid<T> extends ControlValue implements AfterContentChecked {
    ...
    protected readonly _pagesLoaded: _angular_core.WritableSignal<number>;
...
declare class WIALoading {
    isLoading: _angular_core.InputSignal<boolean>;
    position: _angular_core.InputSignal<"absolute" | "sticky">;
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<WIALoading, never>;
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<WIALoading, "wia-loading", never, { "isLoading": { "alias": "isLoading"; "required": false; "isSignal": true; }; "position": { "alias": "position"; "required": false; "isSignal": true; }; }, {}, never, never, false, never>;
}
...
declare class WIATab extends ControlValue {
    private readonly _contentElements;
    protected readonly _value: _angular_core.WritableSignal<number>;
    protected readonly _containerHeight: _angular_core.WritableSignal<number>;
    protected readonly _showingTab: _angular_core.WritableSignal<boolean>;
    ...
    readonly minHeight: _angular_core.InputSignal<string>;
    readonly maxHeight: _angular_core.InputSignal<string>;
    readonly siblings: _angular_core.InputSignal<HTMLElement[]>;
    readonly marginTop: _angular_core.InputSignal<string>;
    readonly marginRight: _angular_core.InputSignal<string>;
    readonly marginLeft: _angular_core.InputSignal<string>;
    protected readonly onClickTab: _angular_core.OutputEmitterRef<number>;
    protected Start(): Promise<void>;
    private CalculateHeight;
    protected _height: _angular_core.Signal<string>;
    protected _tabList: _angular_core.Signal<any[]>;
    protected _GetIcon: (templateRef: ITemplateRef) => string;
    protected _GetLabel: (templateRef: ITemplateRef) => string;
    protected _GetContent: _angular_core.Signal<any>;
    protected _ClickTab(index: number): void;
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<WIATab, never>;
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<WIATab, "wia-tab", never, { "value": { "alias": "value"; "required": false; "isSignal": true; }; "useContainer": { "alias": "useContainer"; "required": false; "isSignal": true; }; "width": { "alias": "width"; "required": false; "isSignal": true; }; "minWidth": { "alias": "minWidth"; "required": false; "isSignal": true; }; "maxWidth": { "alias": "maxWidth"; "required": false; "isSignal": true; }; "height": { "alias": "height"; "required": false; "isSignal": true; }; "minHeight": { "alias": "minHeight"; "required": false; "isSignal": true; }; "maxHeight": { "alias": "maxHeight"; "required": false; "isSignal": true; }; "siblings": { "alias": "siblings"; "required": false; "isSignal": true; }; "marginTop": { "alias": "marginTop"; "required": false; "isSignal": true; }; "marginRight": { "alias": "marginRight"; "required": false; "isSignal": true; }; "marginLeft": { "alias": "marginLeft"; "required": false; "isSignal": true; }; }, { "onClickTab": "onClickTab"; }, ["_contentElements"], never, false, never>;
}

declare class ComponentsModule {
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<ComponentsModule, never>;
    static ɵmod: _angular_core.ɵɵNgModuleDeclaration<ComponentsModule, [typeof WIAButton, typeof WIADateBox, typeof WIAForm, typeof WIAGrid, typeof WIAGridBody, typeof WIAGridCell, typeof WIAGridFooter, typeof WIAGridHeader, typeof WIALoading, typeof WIAModal, typeof WIANumberBox, typeof WIAPageTitle, typeof WIARadio, typeof WIASecretBox, typeof WIASelectBox, typeof WIASwitch, typeof WIATab, typeof WIATextBox], [typeof i19.CommonModule, typeof i20.RouterModule, typeof i21.FormsModule, typeof i21.ReactiveFormsModule, typeof i22.DirectivesModule, typeof i23.PipesModule], [typeof WIAButton, typeof WIADateBox, typeof WIAForm, typeof WIAGrid, typeof WIALoading, typeof WIAModal, typeof WIANumberBox, typeof WIAPageTitle, typeof WIARadio, typeof WIASecretBox, typeof WIASelectBox, typeof WIASwitch, typeof WIATab, typeof WIATextBox]>;
